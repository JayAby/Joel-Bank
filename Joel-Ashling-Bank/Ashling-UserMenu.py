...
class UserSignup:
    def __init__(self, window):
        ...
        self.view_account_balance = Label(self.signup_frame, highlightthickness=2, text='Account Details',
        ...
        #
        self.transfer_money = Label(self.signup_frame, highlightthickness=2, text='Transfer Money',
                               font=('Helvetica', 13, 'bold'), fg='black', bg='white',
                               bd=2)
        ...
        #
        self.pay_bills = Label(self.signup_frame, highlightthickness=2, text='Pay Bills',
                               font=('Helvetica', 13, 'bold'), fg='black', bg='white',
                               bd=2)
        ...
        #
        self.transaction_history = Label(self.signup_frame, highlightthickness=2, text='Transaction History',
                               font=('Helvetica', 13, 'bold'), fg='black', bg='white',
                               bd=2)
        ...
        #
        self.view_personal_details = Label(self.signup_frame, highlightthickness=2, text='Personal Details',
                               font=('Helvetica', 13, 'bold'), fg='black', bg='white',
                               bd=2)
